...
<div id="nav">
	<ul>
		...
		<li id="bridgeManageMenu" class="bridge" title="교량관리" onclick="goPage('/bridge/input-bridge');"><span>교량관리</span></li>
		<li id="bridgeMenu" class="bridge" title="교량" onclick="goPage('/bridge/list-bridge');"><span>교량</span></li>
		<li id="bridgegroupMenu" class="schedule" title="교량그룹" onclick="goPage('/bridgegroup/list-bridgegroup');"><span>교량 그룹</span></li>
