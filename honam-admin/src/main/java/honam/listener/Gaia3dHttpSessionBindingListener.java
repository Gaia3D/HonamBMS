package honam.listener;

import javax.servlet.http.HttpSessionBindingEvent;
import javax.servlet.http.HttpSessionBindingListener;

import honam.support.SessionUserSupport;
...
//			}
		...
		SessionUserSupport.loginUsersMap.put(event.getName(), event.getSession());
	}
	...
	public void valueUnbound(HttpSessionBindingEvent event) {
		...
		SessionUserSupport.loginUsersMap.remove(event.getName(), event.getSession());
	}
}
