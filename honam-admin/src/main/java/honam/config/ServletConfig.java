...
import honam.interceptor.ConfigInterceptor;
import honam.interceptor.LogInterceptor;
...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = { "honam.config, honam.api, honam.controller, honam.interceptor, honam.validator" }, includeFilters = {
