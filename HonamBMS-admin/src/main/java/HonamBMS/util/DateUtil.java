...
public class DateUtil {
	...
	public static String getToday() {
		return getToday(FormatUtil.VIEW_YEAR_MONTH_DAY_TIME);
	}
	...
	public static String getToday(String pattern) {
		...
		return FormatUtil.getDayFormat(calendar.getTime(), pattern);
	}
	...
	public static String getViewDay(Date date, String pattern) {
		return FormatUtil.getDayFormat(date, pattern);
	}
	...
	public static boolean isValidTime(	String dayPattern, 
		...
		if(FormatUtil.YEAR_MONTH_DAY_TIME14.equals(dayPattern)) {
	...
	public static String getMonthLastDay(String yearMonth) {
		...
		return FormatUtil.getDayFormat(calendar.getTime(), FormatUtil.YEAR_MONTH_DAY);
	}
	...
	public static String getAddDate(String type, String value) {
		...
		if("DAY".equals(type)) {
			...
			return FormatUtil.getDayFormat(calendar.getTime(), FormatUtil.YEAR_MONTH_DAY_TIME14);
		} else {
			return null;
		}
	}
